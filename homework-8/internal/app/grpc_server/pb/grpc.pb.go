...
func (x *UpdateUserRespone) Reset() {
	*x = UpdateUserRespone{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateUserRespone) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateUserRespone) ProtoMessage() {}

func (x *UpdateUserRespone) ProtoReflect() protoreflect.Message {
	mi := &file_grpc_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateUserRespone.ProtoReflect.Descriptor instead.
func (*UpdateUserRespone) Descriptor() ([]byte, []int) {
	return file_grpc_proto_rawDescGZIP(), []int{4}
}

func (x *UpdateUserRespone) GetOk() bool {
	if x != nil {
		return x.Ok
	}
	return false
...
var file_grpc_proto_rawDesc = []byte{
	...
	0x70, 0x63, 0x22, 0x3c, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x33, 0x0a, 0x11, 0x55,
	...
	0x22, 0x23, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x6f, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x02, 0x6f, 0x6b, 0x22, 0x12, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x35, 0x0a, 0x11, 0x4c, 0x69, 0x73,
	...
	0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52,
	0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0x8c, 0x02, 0x0a, 0x0b, 0x47, 0x52, 0x50, 0x43, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x41, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55,
	0x73, 0x65, 0x72, 0x12, 0x17, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x65, 0x22, 0x00, 0x12, 0x3e, 0x0a, 0x09, 0x4c, 0x69,
	...
	0x73, 0x65, 0x22, 0x00, 0x42, 0x2b, 0x5a, 0x29, 0x68, 0x6f, 0x6d, 0x65, 0x77, 0x6f, 0x72, 0x6b,
	0x2d, 0x38, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x61, 0x70, 0x70, 0x2f,
	0x67, 0x72, 0x70, 0x63, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x70, 0x62, 0x3b, 0x70,
...
var file_grpc_proto_goTypes = []interface{}{
	...
	(*UpdateUserRespone)(nil),  // 4: grpc.UpdateUserRespone
	(*ListUsersRequest)(nil),   // 5: grpc.ListUsersRequest
	(*ListUsersResponse)(nil),  // 6: grpc.ListUsersResponse
	(*GetUserRequest)(nil),     // 7: grpc.GetUserRequest
	(*GetUserResponse)(nil),    // 8: grpc.GetUserResponse
}
var file_grpc_proto_depIdxs = []int32{
	0, // 0: grpc.CreateUserRequest.user:type_name -> grpc.User
	0, // 1: grpc.UpdateUserRequest.user:type_name -> grpc.User
	0, // 2: grpc.ListUsersResponse.users:type_name -> grpc.User
	0, // 3: grpc.GetUserResponse.user:type_name -> grpc.User
	1, // 4: grpc.GRPCService.CreateUser:input_type -> grpc.CreateUserRequest
	3, // 5: grpc.GRPCService.UpdateUser:input_type -> grpc.UpdateUserRequest
	5, // 6: grpc.GRPCService.ListUsers:input_type -> grpc.ListUsersRequest
	7, // 7: grpc.GRPCService.GetUser:input_type -> grpc.GetUserRequest
	2, // 8: grpc.GRPCService.CreateUser:output_type -> grpc.CreateUserResponse
	4, // 9: grpc.GRPCService.UpdateUser:output_type -> grpc.UpdateUserRespone
	6, // 10: grpc.GRPCService.ListUsers:output_type -> grpc.ListUsersResponse
	8, // 11: grpc.GRPCService.GetUser:output_type -> grpc.GetUserResponse
...
func file_grpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_grpc_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateUserRespone); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
